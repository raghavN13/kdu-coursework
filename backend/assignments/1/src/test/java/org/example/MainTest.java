...
import org.example.Assignment.Coin;
import org.example.Assignment.ExecuteTransaction;
import org.example.Assignment.Main;
import org.example.Assignment.Trader;
...
public class MainTest {
    ...
    public void testParseCSV() throws IOException {
        ...
        assertEquals(expectedCoins.size(), actual.size());
        ...
        assertEquals(expectedTraders.size(), actualTraders.size());
    ...
    public void testConcurrentTransactions() {
        ...
        try {
            ...
            Object String;
            Object Map;
            Main.executeTransactions(transactionArray, latch,coinMap,traderMap);
